...
// NOTE TypeScript currently has an issue regarding
 ...
 * selector.
 * This function is only necessary if the Redux UI State reducer is not located at `state.uiState` (the default
